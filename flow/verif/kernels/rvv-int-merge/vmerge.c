/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmerge.
...
int main(void) {
    ...
    report_e8("vmerge.vvm e8 m1 avl=37", R, 37);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vmerge.vvm e16 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vmerge.vvm e32 m1 avl=37", R, 37);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vmerge.vvm e64 m1 avl=37", R, 37);
    ...
    "li t1,21\n"
    "vle32.v v8,(%[A])\n"
    "vmerge.vxm v24,v8,t1,v0\n"
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vmerge.vxm e32 m1 avl=37", R, 37);

    asm volatile(
    "vsetvli t0,%[vl],e32,m1,ta,ma\n"
    "vlm.v v0,(%[M])\n"
    "vle32.v v8,(%[A])\n"
    "vmerge.vim v24,v8,5,v0\n"
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vmerge.vim e32 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vmerge.vvm e32 m2 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vmerge.vvm e32 m8 avl=37", R, 37);
    VEND();
    return 0;
}
