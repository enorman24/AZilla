/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vslidedown.
...
int main(void) {
    ...
    "vle8.v v8,(%[A])\n"
    "li t1,3\n"
    "vslidedown.vx v24,v8,t1\n"
    "vse8.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e8("vslidedown.vx e8 m1 avl=37", R, 37);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vslidedown.vx e16 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vslidedown.vx e32 m1 avl=37", R, 37);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vslidedown.vx e64 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vslidedown.vi e32 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vslidedown.vx e32 m2 avl=37", R, 37);
    VEND();
    return 0;
}
