/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vcompress.
...
int main(void) {
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[M]"r"(M),[R]"r"(R),[vl]"r"(16UL) : "t0","t1","memory");
    report_e32("vcompress.vm e32 m1", R, 16);
    VEND();
    return 0;
}
