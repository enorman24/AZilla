/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmv1r.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * whole-register move (decoded as VMERGE)
 */
#include "verif.h"
...
int main(void) {
    ...
    report_e32("vmv1r.v (first 8 e32 elems)", R, 8);
    VEND();
    return 0;
}
