/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vsse32.v.
...
int main(void) {
    ...
    "vlse32.v v16,(%[R]),%[st]\n"
    "vse32.v v16,(%[D])\n"
    :: [A]"r"(A),[R]"r"(R),[D]"r"(D0),[vl]"r"(24UL),[st]"r"(8UL) : "t0","t1","memory");
    report_e32("vsse32.v m1 avl=24 stride=8B", D0, 24);
    VEND();
    return 0;
}
