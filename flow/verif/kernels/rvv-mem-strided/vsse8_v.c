/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vsse8.v.
...
int main(void) {
    ...
    "vlse8.v v16,(%[R]),%[st]\n"
    "vse8.v v16,(%[D])\n"
    :: [A]"r"(A),[R]"r"(R),[D]"r"(D0),[vl]"r"(24UL),[st]"r"(2UL) : "t0","t1","memory");
    report_e8("vsse8.v m1 avl=24 stride=2B", D0, 24);
    VEND();
    return 0;
}
