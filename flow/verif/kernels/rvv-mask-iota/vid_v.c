/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vid.v.
...
int main(void) {
    ...
    report_e8("vid.v e8 m1 avl=37", R, 37);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vid.v e16 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vid.v e32 m1 avl=37", R, 37);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vid.v e64 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vid.v e32 m2 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vid.v e32 m8 avl=37", R, 37);
    VEND();
    return 0;
}
