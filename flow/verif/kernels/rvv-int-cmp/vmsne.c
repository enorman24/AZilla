/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmsne.
...
int main(void) {
    ...
    report_bytes("vmsne.vv e8 m1 vl=32", R, 4);
    ...
    "vmsne.vv v24,v8,v16\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vv e16 m1 vl=32", R, 4);
    ...
    "vmsne.vv v24,v8,v16\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vv e32 m1 vl=32", R, 4);
    ...
    "vmsne.vv v24,v8,v16\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vv e64 m1 vl=32", R, 4);
    ...
    "vmsne.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vx e32 m1 vl=32", R, 4);
    ...
    "vmsne.vi v24,v8,5\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vi e32 m1 vl=32", R, 4);
    ...
    "vmsne.vv v24,v8,v16\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vv e32 m2 vl=32", R, 4);
    ...
    "vmsne.vv v24,v8,v16\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsne.vv e32 m8 vl=32", R, 4);
    VEND();
    return 0;
}
