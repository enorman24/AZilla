/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmsgtu.
...
int main(void) {
    ...
    report_bytes("vmsgtu.vx e8 m1 vl=32", R, 4);
    ...
    "vmsgtu.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vx e16 m1 vl=32", R, 4);
    ...
    "vmsgtu.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vx e32 m1 vl=32", R, 4);
    ...
    "vmsgtu.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vx e64 m1 vl=32", R, 4);
    ...
    "vmsgtu.vi v24,v8,5\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vi e32 m1 vl=32", R, 4);
    ...
    "vmsgtu.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vx e32 m2 vl=32", R, 4);
    ...
    "vmsgtu.vx v24,v8,t1\n vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsgtu.vx e32 m8 vl=32", R, 4);
    VEND();
    return 0;
}
