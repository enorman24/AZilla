/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmxnor.
...
int main(void) {
    ...
    report_bytes("vmxnor.mm m1 vl=32", R, 4);
    ...
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmxnor.mm m2 vl=32", R, 4);
    ...
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmxnor.mm m8 vl=32", R, 4);
    VEND();
    return 0;
}
