/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmand.
...
int main(void) {
    ...
    report_bytes("vmand.mm m1 vl=32", R, 4);
    ...
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmand.mm m2 vl=32", R, 4);
    ...
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmand.mm m8 vl=32", R, 4);
    VEND();
    return 0;
}
