/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vsbc.
...
int main(void) {
    ...
    "vle8.v v8,(%[A])\n"
    "vle8.v v16,(%[B])\n"
    "vsbc.vvm v24,v8,v16,v0\n"
    "vse8.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e8("vsbc.vvm e8 m1 avl=37", R, 37);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vsbc.vvm e16 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vsbc.vvm e32 m1 avl=37", R, 37);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vsbc.vvm e64 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vsbc.vxm e32 m1 avl=37", R, 37);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[M]"r"(M),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vsbc.vvm e32 m2 avl=37", R, 37);
    VEND();
    return 0;
}
