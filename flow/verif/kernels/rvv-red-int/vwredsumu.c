/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vwredsumu.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * widening sum reduction unsigned
 */
#include "verif.h"
...
int main(void) {
    ...
    "vle8.v v8,(%[A])\n"
    "vwredsumu.vs v24,v8,v4\n"
    "vsetvli t0,%[vl],e16,m2,ta,ma\n"
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vwredsumu.vs e8->e16 m1 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vwredsumu.vs e16->e32 m1 avl=37", R, 1);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vwredsumu.vs e32->e64 m1 avl=37", R, 1);
    VEND();
    return 0;
}
