/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vredxor.
...
int main(void) {
    ...
    "li t1,1\n"
    "vmv.s.x v4,t1\n"
    "vredxor.vs v24,v8,v4\n"
    "vse8.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e8("vredxor.vs e8 m1 avl=37", R, 1);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vredxor.vs e16 m1 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredxor.vs e32 m1 avl=37", R, 1);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vredxor.vs e64 m1 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredxor.vs e32 m2 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredxor.vs e32 m4 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredxor.vs e32 m8 avl=37", R, 1);
    VEND();
    return 0;
}
