/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vredor.
...
int main(void) {
    ...
    report_e8("vredor.vs e8 m1 avl=37", R, 1);
    ...
    "vse16.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e16("vredor.vs e16 m1 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredor.vs e32 m1 avl=37", R, 1);
    ...
    "vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vredor.vs e64 m1 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredor.vs e32 m2 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredor.vs e32 m4 avl=37", R, 1);
    ...
    "vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vredor.vs e32 m8 avl=37", R, 1);
    VEND();
    return 0;
}
