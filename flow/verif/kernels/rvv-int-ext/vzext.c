/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vzext.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * zero-extend vf2/vf4/vf8
 */
#include "verif.h"
...
int main(void) {
    ...
    report_e16("vzext.vf2 e8->e16 m1 avl=37", R, 37);
    ...
    "vzext.vf4 v24,v8\n vse32.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","memory");
    report_e32("vzext.vf4 e8->e32 m1 avl=37", R, 37);
    ...
    "vzext.vf8 v24,v8\n vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(37UL) : "t0","memory");
    report_e64("vzext.vf8 e8->e64 m1 avl=37", R, 37);
    VEND();
    return 0;
}
