/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vle32.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * unit-stride load (extraction primitive: verify early)
 */
#include "verif.h"
...
int main(void) {
    ...
    report_e32("vle32.v m1 avl=37 (unit ld/st round-trip)", R, 37);
    VEND();
    return 0;
}
