/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vwmul.
...
int main(void) {
    ...
    report_e16("vwmul.vv e8->e16 m1 avl=37", R, 37);
    ...
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[D]"r"(D0),[vl]"r"(37UL) : "t0","t1","memory");
    report_e32("vwmul.vv e16->e32 m1 avl=37", R, 37);
    ...
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[D]"r"(D0),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vwmul.vv e32->e64 m1 avl=37", R, 37);
    ...
    "vsetvli t0,%[vl],e64,m2,ta,ma\n vse64.v v24,(%[R])\n"
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[D]"r"(D0),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vwmul.vx e32->e64 m1 avl=37", R, 37);
    ...
    :: [A]"r"(A),[B]"r"(B),[R]"r"(R),[D]"r"(D0),[vl]"r"(37UL) : "t0","t1","memory");
    report_e64("vwmul.vv e32->e64 m2 avl=37", R, 37);
    VEND();
    return 0;
}
