/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vmsif.m.
...
int main(void) {
    ...
    "vmsif.m v24,v0\n"
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsif.m m1 vl=32", R, 4);
    ...
    "vsm.v v24,(%[R])\n"
    :: [A]"r"(A),[R]"r"(R),[vl]"r"(32UL) : "t0","t1","memory");
    report_bytes("vmsif.m m2 vl=32", R, 4);
    VEND();
    return 0;
}
