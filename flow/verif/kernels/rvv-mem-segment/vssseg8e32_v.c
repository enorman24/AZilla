/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vssseg8e32.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * strided segment store: silent mis-decode
 */
#include "verif.h"
...
int main(void) {
    ...
    "vle32.v v8,(%[A])\n"
    "vssseg8e32.v v8,(%[R]),%[st]\n"
    :: [A]"r"(A),[R]"r"(R),[I]"r"(IDX),[st]"r"(8UL),[vl]"r"(16UL) : "t0","t1","memory");
    report_e32("vssseg8e32.v m1 avl=16", R, 16);
    VEND();
    return 0;
}
