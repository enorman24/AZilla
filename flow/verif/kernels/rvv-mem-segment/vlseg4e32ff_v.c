/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vlseg4e32ff.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * fault-only-first segment load: ff lumop traps illegal regardless of nf
 */
#include "verif.h"
...
int main(void) {
    ...
    report_e32("vlseg4e32ff.v m1 avl=16", R, 16);
    VEND();
    return 0;
}
