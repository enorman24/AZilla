/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vsuxseg8ei32.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * indexed-unordered segment store: silent mis-decode
 */
#include "verif.h"
...
int main(void) {
    fill();
    VBEGIN();
    for (int _i = 0; _i < 16; _i++) ((uint32_t *)IDX)[_i] = (uint32_t)(_i * 4);
    asm volatile(
    "vsetvli t0,%[vl],e32,m1,ta,ma\n"
    "vle32.v v16,(%[I])\n"
    "vle32.v v8,(%[A])\n"
    "vsuxseg8ei32.v v8,(%[R]),v16\n"
    :: [A]"r"(A),[R]"r"(R),[I]"r"(IDX),[st]"r"(8UL),[vl]"r"(16UL) : "t0","t1","memory");
    report_e32("vsuxseg8ei32.v m1 avl=16", R, 16);
    VEND();
    return 0;
}
