/* AUTO-GENERATED by flow/verif/scripts/gen_kernels.py - directed test for vlseg4e32.v.
 * Differential vs Spike; per-variant #V blocks. Do not hand-edit; regenerate.
 * unit-stride segment load: nf not decoded -> silently treated as non-segment
 */
#include "verif.h"
...
int main(void) {
    ...
    report_e32("vlseg4e32.v m1 avl=16", R, 16);
    VEND();
    return 0;
}
